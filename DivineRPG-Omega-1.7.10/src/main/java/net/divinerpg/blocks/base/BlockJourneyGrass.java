...
public class BlockJourneyGrass
extends BlockMod {
    protected IIcon top;
    ...
    public BlockJourneyGrass(Block dirt, String name, String dirtName, float hardness) {
    ...
    public void registerBlockIcons(IIconRegister icon) {
        ...
        this.bottom = icon.registerIcon(this.textureName + "_bottom");
    }
