...
public class GUIOverlay {
    ...
    public void drawArmor() {
        ...
        if (boots == TwilightItemsArmor.awakenedBoots && legs == TwilightItemsArmor.awakenedLeggings && body == TwilightItemsArmor.awakenedChestplate && helmet == TwilightItemsArmor.awakenedHelmet) {
            size = 1;
        }
        if (boots == TwilightItemsArmor.arcaniumBoots && legs == TwilightItemsArmor.arcaniumLeggings && body == TwilightItemsArmor.arcaniumChestplate && helmet == TwilightItemsArmor.arcaniumHelmet) {
            size = 1;
        }
        switch (size) {
            case 1: {
