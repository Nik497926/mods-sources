...
public class ModelEternalArcher
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.armsRight[0].render(f5);
        this.armsLeft[2].render(f5);
        this.rightleg.render(f5);
        this.leftleg.render(f5);
        this.armsRight[2].render(f5);
        this.armsLeft[0].render(f5);
        this.armsLeft[1].render(f5);
        this.armsRight[1].render(f5);
        this.body.render(f5);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (s < 3) {
            this.armsRight[s].rotateAngleX = (float)((double)this.armsRight[s].rotateAngleX - 0.4);
        } else {
            this.armsLeft[s - 3].rotateAngleX = (float)((double)this.armsLeft[s - 3].rotateAngleX - 0.4);
        }
    }
}
