...
public class Util {
    ...
    public static boolean isDonatorName(String s) {
        return s.equalsIgnoreCase("makaka") || s.equalsIgnoreCase("heroinfathre");
    }
    ...
    public static void registerDivineRPGMob(Class entityClass, String entityName) {
        ...
        EntityRegistry.registerModEntity((Class)entityClass, (String)entityName, (int)mobID++, (Object)DivineRPG.instance, (int)64, (int)3, (boolean)true);
        int id = entityListID++;
    ...
    public static void registerProjectile(Class entityClass, String entityName) {
        EntityRegistry.registerModEntity((Class)entityClass, (String)(entityName + "Projectile"), (int)projectileID, (Object)DivineRPG.instance, (int)64, (int)5, (boolean)true);
        ++projectileID;
    }
    ...
    public static ChunkCoordinates getPlayerSpawnChunk(EntityPlayer player) {
        ...
        ChunkCoordinates coords = (ChunkCoordinates)ObfuscationReflectionHelper.getPrivateValue(EntityPlayer.class, (Object)player, (String[])spawnChunkNames);
        return coords;
    }

    public static HashMap getPlayerSpawnChunkMap(EntityPlayer player) {
        String[] spawnChunkMapNames = new String[]{"spawnChunkMap", "spawnChunkMap", "spawnChunkMap"};
        HashMap map = (HashMap)ObfuscationReflectionHelper.getPrivateValue(EntityPlayer.class, (Object)player, (String[])spawnChunkMapNames);
        return map;
    }
    ...
    public static MovingObjectPosition rayTrace(EntityPlayer player, double distance) {
        ...
        return player.worldObj.rayTraceBlocks(pos, vec32, true);
    }
