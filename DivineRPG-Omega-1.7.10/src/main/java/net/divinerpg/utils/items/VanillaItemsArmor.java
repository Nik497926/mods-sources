...
public class VanillaItemsArmor {
    ...
    private static Object[] amazoniteInfo = new Object[]{25, ArmorInfo.RANGED_PROTECTION, 60, ArmorInfo.MELEE_PROTECTION, 2.0, ArmorInfo.SPEED};
    public static Item amazoniteHelmet = new ItemSpeedArmor(EnumArmor.AMAZONITE, HEAD, amazoniteInfo, 0.5f);
    public static Item amazoniteChestplate = new ItemSpeedArmor(EnumArmor.AMAZONITE, BODY, amazoniteInfo, 0.5f);
    public static Item amazoniteLeggings = new ItemSpeedArmor(EnumArmor.AMAZONITE, LEGS, amazoniteInfo, 0.5f);
    public static Item amazoniteBoots = new ItemSpeedArmor(EnumArmor.AMAZONITE, BOOTS, amazoniteInfo, 0.5f);
    private static Object[] nightmareInfo = new Object[]{ArmorInfo.FIRE_PROTECTION, ArmorInfo.SMALL_REGEN};
    public static Item nightmareHelmet = new ItemDivineArmor(EnumArmor.NIGHTMARE, HEAD, nightmareInfo);
    public static Item nightmareChestplate = new ItemDivineArmor(EnumArmor.NIGHTMARE, BODY, nightmareInfo);
    public static Item nightmareLeggings = new ItemDivineArmor(EnumArmor.NIGHTMARE, LEGS, nightmareInfo);
    public static Item nightmareBoots = new ItemDivineArmor(EnumArmor.NIGHTMARE, BOOTS, nightmareInfo);
    private static Object[] netheriumInfo = new Object[]{ArmorInfo.FIRE_PROTECTION, 25, ArmorInfo.MELEE_PROTECTION, 4, ArmorInfo.MELEE_DAMAGE};
    public static Item netheriumHelmet = new ItemDivineArmor(EnumArmor.NETHERIUM, HEAD, netheriumInfo);
    public static Item netheriumChestplate = new ItemDivineArmor(EnumArmor.NETHERIUM, BODY, netheriumInfo);
    public static Item netheriumLeggings = new ItemDivineArmor(EnumArmor.NETHERIUM, LEGS, netheriumInfo);
    public static Item netheriumBoots = new ItemDivineArmor(EnumArmor.NETHERIUM, BOOTS, netheriumInfo);
    public static Item copperHelmet = new ItemDivineArmor(EnumArmor.COPPER, HEAD);
    public static Item copperChestplate = new ItemDivineArmor(EnumArmor.COPPER, BODY);
    public static Item copperLeggings = new ItemDivineArmor(EnumArmor.COPPER, LEGS);
    public static Item copperBoots = new ItemDivineArmor(EnumArmor.COPPER, BOOTS);
    private static Object[] divineInfo = new Object[]{4, ArmorInfo.MELEE_DAMAGE, 2, ArmorInfo.JUMP_HEIGHT, ArmorInfo.NO_FALL};
    ...
    public static Item shadowHelmet = new ItemSpeedArmor(EnumArmor.SHADOW, HEAD, shadowInfo, 0.75f);
    public static Item shadowBody = new ItemSpeedArmor(EnumArmor.SHADOW, BODY, shadowInfo, 0.75f);
    public static Item shadowLegs = new ItemSpeedArmor(EnumArmor.SHADOW, LEGS, shadowInfo, 0.75f);
    public static Item shadowBoots = new ItemSpeedArmor(EnumArmor.SHADOW, BOOTS, shadowInfo, 0.75f);
    ...
    private static Object[] archerInfo = new Object[]{50, ArmorInfo.RANGED_DAMAGE};
    public static Item archerHelmet = new ItemDivineArmor(EnumArmor.ARCHER, HEAD, archerInfo);
    public static Item archerBody = new ItemDivineArmor(EnumArmor.ARCHER, BODY, archerInfo);
    public static Item archerLegs = new ItemDivineArmor(EnumArmor.ARCHER, LEGS, archerInfo);
    public static Item archerBoots = new ItemDivineArmor(EnumArmor.ARCHER, BOOTS, archerInfo);
