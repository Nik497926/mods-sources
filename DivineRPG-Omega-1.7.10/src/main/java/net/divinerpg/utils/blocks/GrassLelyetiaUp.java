...
implements IGrowable {
    ...
    public GrassLelyetiaUp(Material p_i45394_1_) {
        super(p_i45394_1_);
    ...
    public void registerBlockIcons(IIconRegister icon) {
        this.top = icon.registerIcon("divinerpg:grassLelyetia_end");
        this.side = icon.registerIcon("divinerpg:grassLelyetiaUp_side");
        this.bottom = icon.registerIcon("divinerpg:stoneLelyetia");
        this.blockIcon = icon.registerIcon("divinerpg:grassLelyetiaUp_side");
    }
}
