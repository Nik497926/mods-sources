...
public class ArcanaBlocks {
    ...
    public static Block arcaniumMetal = new BlockMod("arcaniumMetal", 4.0f);
    ...
    public static Block arcanaLamp = new BlockMod("arcanaLamp", false).setLightLevel(1.0f);
    public static Block heatTrap = new BlockHeatTrap("heatTrap", -1.0f);
    public static Block heatTrapOn = new BlockHeatTrap("heatTrapOn", -1.0f);
    public static Block soulStone = new BlockMod("soulStone", false);
    public static Block soulSludge = new BlockMod("soulSludge", false);
    public static Block degradedBrick = new BlockMod("degradedBrick", 4.0f);
    public static Block darkDegradedBrick = new BlockMod("darkDegradedBrick", false);
    public static Block ancientBrick = new BlockMod("ancientBrick", 4.0f);
    public static Block ancientStone = new BlockMod("ancientStone", 4.0f);
    ...
    public static Block dungenSpawnerPrisoner = new BlockStupidSpawner("dungeonPrisonerSpawner", "DungeonPrisoner", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    public static Block razorbackSpawner = new BlockStupidSpawner("razorbackSpawner", "Razorback", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    public static Block deathHoundSpawner = new BlockStupidSpawner("deathHoundSpawner", "DeathHound", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    public static Block deathcryxSpawner = new BlockStupidSpawner("deathcryxSpawner", "Deathcryx", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    public static Block livingStatueSpawner = new BlockStupidSpawner("livingStatueSpawner", "LivingStatue", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    public static Block roamerSpawner = new BlockStupidSpawner("roamerSpawner", "Roamer", "arcanaSpawner", false).setBlockUnbreakable().setResistance(6000000.0f);
    ...
    public static Block soulSludgeDoor = new BlockModDoor(EnumBlockType.IRON, "soulSludgeDoor", -1.0f, false);
    public static Block ancientBrickDoor = new BlockModDoor(EnumBlockType.IRON, "ancientBrickDoor", -1.0f, false);
    public static Block soulStoneDoor = new BlockModDoor(EnumBlockType.IRON, "soulStoneDoor", -1.0f, false);
    public static Block degradedBrickDoor = new BlockModDoor(EnumBlockType.IRON, "degradedBrickDoor", -1.0f, false);
    ...
    public static Block arcanaHardPortalFrame = new BlockArcanaFrame("arcanaHardPortalFrame", arcanaPortal).setBlockUnbreakable().setResistance(6000000.0f).setCreativeTab(null);
    ...
    public static Block eucalyptusPlank = new BlockMod(EnumBlockType.WOOD, "eucalyptusPlanks", 2.0f, DivineRPGTabs.blocks).setResistance(5.0f);
