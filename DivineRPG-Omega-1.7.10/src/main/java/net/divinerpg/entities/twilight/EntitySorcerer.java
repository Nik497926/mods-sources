...
extends EntityDivineRPGMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.sorcererHealth);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(EntityStats.sorcererDamage);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(EntityStats.sorcererSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(EntityStats.sorcererFollowRange);
    }
    ...
    public void onUpdate() {
        ...
        if (this.ticksExisted % 30 == 0) {
            ...
            if (this.entityToAttack != null && !this.worldObj.isRemote) {
                ...
                EntityTwilightMageShot e = new EntityTwilightMageShot(this.worldObj, (EntityLivingBase)this, 97, 31, 54);
