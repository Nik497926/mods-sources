...
extends EntityDivineRPGTameable {
    ...
    public void onUpdate() {
        ...
        float f = this.field_70926_e = this.func_70922_bv() ? (this.field_70926_e = this.field_70926_e + (1.0f - this.field_70926_e) * 0.4f) : (this.field_70926_e = this.field_70926_e + (0.0f - this.field_70926_e) * 0.4f);
