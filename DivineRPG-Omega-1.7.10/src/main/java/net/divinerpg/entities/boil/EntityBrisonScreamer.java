...
public class EntityBrisonScreamer
extends EntityDivineRPGFlying {
    ...
    public EntityBrisonScreamer(World var1) {
        super(var1);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.screamerHealth + 15.0);
