...
public class modelLelyetianCaster
extends ModelBase {
    ModelRenderer head;
    ModelRenderer body;
    ...
    public modelLelyetianCaster() {
        ...
        this.head.setRotationPoint(6.0f, -8.0f, 0.0f);
        this.head.setTextureSize(64, 32);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        this.body = new ModelRenderer((ModelBase)this, 41, 0);
        this.body.addBox(-4.0f, 0.0f, -2.0f, 4, 10, 4);
        this.body.setRotationPoint(-4.0f, -8.0f, 0.0f);
        this.body.setTextureSize(64, 32);
        this.body.mirror = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        this.rightarm = new ModelRenderer((ModelBase)this, 3, 34);
        this.rightarm.addBox(-1.0f, 3.0f, -10.0f, 0, 8, 14);
        ...
        this.head2.addBox(-3.0f, -6.0f, -3.0f, 6, 6, 6);
        ...
        this.head3.addBox(-3.0f, -6.0f, -3.0f, 6, 6, 6);
        this.head3.setRotationPoint(-6.0f, -8.0f, 0.0f);
        ...
        this.body2.addBox(-4.0f, 0.0f, -2.0f, 8, 12, 4);
        this.body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.body2.setTextureSize(64, 32);
        this.body2.mirror = true;
        this.setRotation(this.body2, 0.0f, 0.0f, 0.0f);
        this.body3 = new ModelRenderer((ModelBase)this, 24, 0);
        this.body3.addBox(-4.0f, 0.0f, -2.0f, 4, 1, 4);
        this.body3.setRotationPoint(2.0f, -1.0f, 0.0f);
        this.body3.setTextureSize(64, 32);
        this.body3.mirror = true;
        this.setRotation(this.body3, 0.0f, 0.0f, 0.0f);
        this.body4 = new ModelRenderer((ModelBase)this, 41, 0);
        this.body4.addBox(-4.0f, 0.0f, -2.0f, 4, 10, 4);
        this.body4.setRotationPoint(8.0f, -8.0f, 0.0f);
        ...
        this.rightarm2.setRotationPoint(-6.0f, 4.0f, 0.0f);
        this.rightarm2.setTextureSize(64, 32);
        this.rightarm2.mirror = true;
        this.setRotation(this.rightarm2, 0.0f, 0.0f, 0.0f);
        this.rightarm3 = new ModelRenderer((ModelBase)this, 38, 34);
        this.rightarm3.addBox(-2.0f, 6.0f, -4.0f, 2, 2, 9);
        this.rightarm3.setRotationPoint(-6.0f, 4.0f, 0.0f);
        this.rightarm3.setTextureSize(64, 32);
        this.rightarm3.mirror = true;
        this.setRotation(this.rightarm3, -0.6981317f, 0.0f, 0.0f);
    }
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.rightarm.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + (float)Math.PI)) * 2.0f * par2 * 0.5f - 0.698f;
        ...
        this.rightarm3.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + (float)Math.PI)) * 2.0f * par2 * 0.5f - 0.698f;
