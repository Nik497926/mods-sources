...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random r, int x, int y, int z) {
        ...
        ItemDoor.placeDoorBlock((World)w, (int)(x + 1), (int)(y + 1), (int)(z + 4), (int)0, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 1), (int)(y + 1), (int)(z + 6), (int)7, (Block)IceikaBlocks.steelDoorBlock);
