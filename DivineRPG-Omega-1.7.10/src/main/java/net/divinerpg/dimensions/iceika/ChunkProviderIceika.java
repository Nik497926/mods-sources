                    ...
                    for(int l2 = 0; l2 < 8; ++l2) {
                        ...
                        for(int i3 = 0; i3 < 4; ++i3) {
                            ...
                            for(int k3 = 0; k3 < 4; ++k3) {
                                b[j3 += short1] = (d15 += d16) > 0.0D ? IceikaBlocks.frozenStone : (k2 * 8 + l2 < 62 ? IceikaBlocks.frozenDirt : (k2 * 8 + l2 < b0 ? IceikaBlocks.frozenGrass : null));
                            }
