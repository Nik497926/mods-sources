...
extends ItemFood {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        list.add(TooltipLocalizer.hunger(this.func_150905_g(stack)));
        list.add(TooltipLocalizer.saturation(this.func_150906_h(stack)));
        list.add(!this.isWolfsFavoriteMeat() ? Util.BLUE + StatCollector.translateToLocal((String)"tooltip.petfood") + EnumChatFormatting.RESET + StatCollector.translateToLocal((String)"tooltip.false") : Util.BLUE + StatCollector.translateToLocal((String)"tooltip.petfood") + EnumChatFormatting.RESET + StatCollector.translateToLocal((String)"tooltip.true"));
        if (this.time <= 32) {
            list.add(Util.DARK_AQUA + StatCollector.translateToLocal((String)"tooltip.fasteat"));
        }
    }
}
