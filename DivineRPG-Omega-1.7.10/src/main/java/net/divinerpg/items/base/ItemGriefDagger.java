...
public class ItemGriefDagger
extends ItemModSword {
    private Random rand = new Random();

    public ItemGriefDagger(String name, Item.ToolMaterial mat) {
        super(mat, name);
    }

    public boolean hitEntity(ItemStack stack, EntityLivingBase live, EntityLivingBase player) {
        live.addPotionEffect(new PotionEffect(Potion.wither.id, 60, 0));
    ...
    public void addInformation(ItemStack item, EntityPlayer player, List list, boolean par4) {
        ...
        list.add(ChatFormatting.GOLD + I18n.format((String)"items.griefdagger", (Object[])new Object[0]));
