...
public class BlockMoltenFurnace
extends BlockModFurnace {
    ...
    public void registerBlockIcons(IIconRegister par1IIconRegister) {
        this.side = par1IIconRegister.registerIcon("divinerpg:moltenFurnace_side");
        this.front = par1IIconRegister.registerIcon(this.active ? "divinerpg:moltenFurnace_front_on" : "divinerpg:moltenFurnace_front_off");
        this.top = par1IIconRegister.registerIcon("divinerpg:moltenFurnace_top");
    }
    ...
    public static void updateFurnaceBlockState(boolean act, World par1World, int par2, int par3, int par4) {
        ...
        keepInventory = true;
        if (act) {
            par1World.setBlock(par2, par3, par4, ArcanaBlocks.moltenFurnaceOn);
        } else {
            par1World.setBlock(par2, par3, par4, ArcanaBlocks.moltenFurnace);
        }
        keepInventory = false;
