...
extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotNumber) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (slotNumber != 1 && slotNumber != 0 ? (itemstack1 != null && itemstack1.getItem() == Item.getItemFromBlock((Block)ArcanaBlocks.arcaniumOre) ? !this.mergeItemStack(itemstack1, 0, 1, false) : (itemstack1 != null && itemstack1.getItem() == ArcanaItems.chargedCollector ? !this.mergeItemStack(itemstack1, 1, 2, false) : (slotNumber >= 3 && slotNumber < 30 ? !this.mergeItemStack(itemstack1, 30, 39, false) : slotNumber >= 30 && slotNumber < 39 && !this.mergeItemStack(itemstack1, 3, 30, false)))) : !this.mergeItemStack(itemstack1, 3, 39, false)) {
                return null;
            }
