...
import net.divinerpg.entities.boil.projectile.EntityMagmaFireball;
...
extends EntityDivineRPGFlying {
    ...
    public EntityLavasnake(World var1) {
        super(var1);
    }
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.lavasnakeHealth);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(EntityStats.lavasnakeSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(EntityStats.lavasnakeFollowRange);
    }
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity((Entity)this) < d4 * d4) {
            ...
            if (this.canEntityBeSeen(this.targetedEntity)) {
                ...
                if (this.attackCounter == 20) {
                    ...
                    EntityMagmaFireball shot = new EntityMagmaFireball(this.worldObj, (EntityLivingBase)this, d5, d6, d7);
