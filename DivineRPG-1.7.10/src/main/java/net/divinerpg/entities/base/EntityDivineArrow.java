    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            for (i = 0; i < list.size(); ++i) {
                ...
                if (!entity1.canBeCollidedWith() || entity1 == this.shootingEntity && this.ticksInAir < 5 || (movingobjectposition1 = (axisalignedbb1 = entity1.boundingBox.expand((double)0.3f, (double)(f1 = 0.3f), (double)f1)).calculateIntercept(vec31, vec3)) == null) continue;
                double d1 = vec31.distanceTo(movingobjectposition1.hitVec);
                if (d >= d0 && d0 != 0.0) continue;
                entity = entity1;
                d0 = d1;
            }
            if (entity != null) {
            ...
            if (position != null) {
                if (position.entityHit != null) {
                    ...
                    DamageSource damageSource = damagesource = this.shootingEntity == null ? DamageSource.causeArrowDamage((EntityArrow)this, (Entity)this) : DamageSource.causeArrowDamage((EntityArrow)this, (Entity)this.shootingEntity);
                    if (position.entityHit.attackEntityFrom(damagesource, (float)k)) {
                        ...
                        if (this.getTextureName() == "infernoArrow") {
                            position.entityHit.setFire(12);
                        }
                        if (this.getTextureName() == "bluefireArrow" || this.getTextureName() == "snowstormArrow") {
                        ...
                        if (position.entityHit instanceof EntityLivingBase) {
                            ...
                            if (this.knockbackStrength > 0) {
                                float f;
                                float f4 = MathHelper.sqrt_double((double)(this.motionX * this.motionX + this.motionZ * this.motionZ));
                                if (f > 0.0f) {
