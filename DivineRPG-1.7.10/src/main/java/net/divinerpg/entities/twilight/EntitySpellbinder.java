...
public class EntitySpellbinder
extends EntityDivineRPGMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.spellbinderHealth);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(EntityStats.spellbinderDamage);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(EntityStats.spellbinderSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(EntityStats.spellbinderFollowRange);
    }
    ...
    public void onUpdate() {
        ...
        if (this.ticksExisted % 30 == 0) {
            ...
            if (this.entityToAttack != null && !this.worldObj.isRemote) {
                ...
                EntityTwilightMageShot e = new EntityTwilightMageShot(this.worldObj, (EntityLivingBase)this, 234, 158, 253);
    ...
    protected void dropFewItems(boolean var1, int var2) {
        ...
        this.dropItem(TwilightItemsOther.apalachiaSoul, this.rand.nextInt(5) + 1);
