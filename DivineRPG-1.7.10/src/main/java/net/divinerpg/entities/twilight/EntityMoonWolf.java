...
extends EntityDivineRPGTameable {
    ...
    public void onUpdate() {
        ...
        float f = this.headRotationX = this.isRotatingCalled() ? (this.headRotationX = this.headRotationX + (1.0f - this.headRotationX) * 0.4f) : (this.headRotationX = this.headRotationX + (0.0f - this.headRotationX) * 0.4f);
        ...
        if (this.isWet()) {
            ...
            if (this.timeWolfIsShaking > 0.4f) {
                float f2 = (float)this.boundingBox.minY;
                ...
                for (int j = 0; j < i; ++j) {
                    ...
                    this.worldObj.spawnParticle("splash", this.posX + (double)f1, (double)(f2 + 0.8f), this.posZ + (double)f22, this.motionX, this.motionY, this.motionZ);
                }
            }
        }
    }
