...
import net.divinerpg.entities.euca.projectile.EntityShimmererProjectile;
...
extends EntityDivineRPGFlying {
    ...
    public EntityShimmerer(World var1) {
        super(var1);
    }

    protected void applyEntityAttributes() {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.shimmererHealth);
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity((Entity)this) < d4 * d4) {
            ...
            if (this.canEntityBeSeen(this.targetedEntity)) {
                ...
                if (this.attackCounter == 20) {
                    ...
                    EntityShimmererProjectile shot = new EntityShimmererProjectile(this.worldObj, (EntityLivingBase)this, d5, d6, d7);
