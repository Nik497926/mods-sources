...
public class GuiBlacksmith
extends GuiDivineMerchant {
    public GuiBlacksmith(ContainerDivineMerchant container, IMerchant mer) {
        super(container, mer, MessageLocalizer.normal("Blacksmith"), "blacksmith");
    }
