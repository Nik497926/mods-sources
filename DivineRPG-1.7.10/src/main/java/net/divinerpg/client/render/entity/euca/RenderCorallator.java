 ...
 */
package net.divinerpg.client.render.entity.euca;
...
public class RenderCorallator
extends RenderLivingCreature {
    private float scale;
    public int bossTextureID;

    public RenderCorallator(ModelBase var1, float var2, ResourceLocation texture, int id) {
        this(var1, var2, 1.0f, texture, id);
    }

    public RenderCorallator(ModelBase var1, float var2, float var3, ResourceLocation texture, int id) {
    ...
    protected void renderEquippedItems(EntityLivingBase var1, float var2) {
        ...
        if (var3 != null) {
            ...
            for (ModelRenderer r : ((ModelEternalArcher)this.mainModel).armsRight) {
                ...
                GL11.glTranslatef((float)0.57f, (float)0.0f, (float)0.0625f);
                var5 = MinecraftForgeClient.getItemRenderer((ItemStack)var3, (IItemRenderer.ItemRenderType)IItemRenderer.ItemRenderType.EQUIPPED);
                var6 = var5 != null && var5.shouldUseRenderHelper(IItemRenderer.ItemRenderType.EQUIPPED, var3, IItemRenderer.ItemRendererHelper.BLOCK_3D);
                var4 = 0.4f;
                GL11.glTranslatef((float)-0.75f, (float)0.5f, (float)-0.4f);
                GL11.glScalef((float)var4, (float)(-var4), (float)var4);
                GL11.glRotatef((float)120.0f, (float)0.07f, (float)1.0f, (float)-0.6f);
                this.renderManager.itemRenderer.renderItem(var1, var3, 0);
                if (var3.getItem().requiresMultipleRenderPasses()) {
                    for (var7 = 1; var7 < var3.getItem().getRenderPasses(var3.getItemDamage()); ++var7) {
            ...
            for (ModelRenderer r : ((ModelEternalArcher)this.mainModel).armsLeft) {
                GL11.glPushMatrix();
                r.postRender(0.0625f);
                GL11.glTranslatef((float)0.67f, (float)0.0f, (float)0.0625f);
                var5 = MinecraftForgeClient.getItemRenderer((ItemStack)var3, (IItemRenderer.ItemRenderType)IItemRenderer.ItemRenderType.EQUIPPED);
                var6 = var5 != null && var5.shouldUseRenderHelper(IItemRenderer.ItemRenderType.EQUIPPED, var3, IItemRenderer.ItemRendererHelper.BLOCK_3D);
                var4 = 0.4f;
                GL11.glTranslatef((float)-0.75f, (float)0.5f, (float)-0.4f);
                GL11.glScalef((float)var4, (float)(-var4), (float)var4);
                GL11.glRotatef((float)120.0f, (float)-0.05f, (float)1.0f, (float)-0.6f);
                this.renderManager.itemRenderer.renderItem(var1, var3, 0);
                if (var3.getItem().requiresMultipleRenderPasses()) {
                    for (var7 = 1; var7 < var3.getItem().getRenderPasses(var3.getItemDamage()); ++var7) {
                        this.renderManager.itemRenderer.renderItem(var1, var3, var7);
