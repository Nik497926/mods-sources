...
extends ModelBase {
    ...
    public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6) {
        ...
        this.legLB.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
        this.legLBT.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
        this.legLM.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
        this.legLMT.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
        this.legLF.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
        this.legLFT.rotateAngleX = MathHelper.cos((float)(var1 * 0.6662f + 3.141593f)) * 1.4f * var2;
    }
}
