...
extends GuiContainer {
    ...
    public GuiExtractor(InventoryPlayer par1InventoryPlayer, TileEntityExtractor par2TileEntityFurnace) {
        super((Container)new ContainerExtractor(par1InventoryPlayer, par2TileEntityFurnace));
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int p_146j976_3_) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("divinerpg:textures/gui/extractor.png"));
