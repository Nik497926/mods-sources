...
import net.divinerpg.client.render.gui.GuiAlloyMender;
import net.divinerpg.client.render.gui.GuiAltarCorruption;
import net.divinerpg.client.render.gui.GuiBlacksmith;
import net.divinerpg.client.render.gui.GuiBoilTrader;
...
import net.divinerpg.client.render.gui.GuiEscapedConvict;
...
import net.divinerpg.client.render.gui.GuiMageTrader;
...
import net.divinerpg.client.render.gui.GuiRockite;
import net.divinerpg.client.render.gui.GuiRuneTrader;
import net.divinerpg.client.render.gui.GuiTinker;
import net.divinerpg.client.render.gui.GuiTrollTrader;
...
implements IGuiHandler {
    ...
    public static int rockite = guiID++;
    public static int blacksmith = guiID++;
    public static int mage = guiID++;
    public static int alloyMender = guiID++;
    public static int escapedConvict = guiID++;
    public static int boilTrader = guiID++;
    public static int trollTrader = guiID++;
    public static int jackOMan = guiID++;
    public static int runeTrader = guiID++;
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == merchant || ID == tinker || ID == zelus || ID == hunger || ID == rockite || ID == blacksmith || ID == mage || ID == alloyMender || ID == escapedConvict || ID == boilTrader || ID == trollTrader || ID == jackOMan || ID == runeTrader || ID == vatticus || ID == leorna || ID == datticon || ID == captainMerik || ID == warGeneral || ID == livestockMerchant) {
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == rockite) {
            return new GuiRockite(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == blacksmith) {
            return new GuiBlacksmith(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == mage) {
            return new GuiMageTrader(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == alloyMender) {
            return new GuiAlloyMender(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == escapedConvict) {
            return new GuiEscapedConvict(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == boilTrader) {
            return new GuiBoilTrader(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == trollTrader) {
            return new GuiTrollTrader(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == runeTrader) {
            return new GuiRuneTrader(new ContainerDivineMerchant(player.inventory, (IMerchant)this.getEntityByID(x, world), world), (IMerchant)this.getEntityByID(x, world));
        }
        if (ID == merchant) {
