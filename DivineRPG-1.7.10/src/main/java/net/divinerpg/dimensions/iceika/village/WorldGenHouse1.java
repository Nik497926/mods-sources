...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random r, int x, int y, int z) {
        ...
        ItemDoor.placeDoorBlock((World)w, (int)x, (int)(y + 1), (int)(z + 2), (int)0, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 8), (int)(y + 1), (int)(z + 2), (int)2, (Block)IceikaBlocks.steelDoorBlock);
