...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random r, int x, int y, int z) {
        ...
        ItemDoor.placeDoorBlock((World)w, (int)(x + 2), (int)(y + 1), (int)(z + 5), (int)1, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 1), (int)(y + 1), (int)(z + 5), (int)1, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 5), (int)(y + 1), (int)(z + 1), (int)0, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 5), (int)(y + 1), (int)(z + 2), (int)0, (Block)IceikaBlocks.steelDoorBlock);
        ...
        if (!w.isRemote) {
            ...
            w.spawnEntityInWorld((Entity)mer);
            w.spawnEntityInWorld((Entity)tink);
        }
        return true;
    }
}
