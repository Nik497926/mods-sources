...
public class WorldGenBlacksmithHouse
extends WorldGenerator {
    public boolean generate(World w, Random r, int x, int y, int z) {
        if (w.getBlock(x - 1, y - 1, z - 1) == Blocks.dirt && w.getBlock(x + 9, y - 1, z + 9) == Blocks.dirt && w.getBlock(x + 9, y - 1, z - 1) == Blocks.dirt && w.getBlock(x - 1, y - 1, z + 9) == Blocks.dirt && w.getBlock(x - 1, y + 3, z - 1) == Blocks.air && w.getBlock(x + 9, y + 3, z + 9) == Blocks.air && w.getBlock(x + 9, y + 3, z - 1) == Blocks.air && w.getBlock(x - 1, y + 3, z + 9) == Blocks.air) {
            ...
            WorldGenAPI.addRectangleWithMetadata(1, 7, 1, w, x, y + 3, z + 1, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(1, 3, 2, w, x, y + 3, z + 3, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(1, 7, 1, w, x + 8, y + 3, z + 1, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(1, 3, 2, w, x + 8, y + 3, z + 3, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(7, 1, 1, w, x + 1, y + 3, z, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(3, 1, 2, w, x + 3, y + 3, z, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(7, 1, 1, w, x + 1, y + 3, z + 8, (Block)Blocks.stained_glass, 0);
            WorldGenAPI.addRectangleWithMetadata(3, 1, 2, w, x + 3, y + 3, z + 8, (Block)Blocks.stained_glass, 0);
            ...
            WorldGenAPI.addBlock(w, x + 8, y + 5, z + 8, Blocks.cobblestone);
            EntityJourneyBlacksmith smith = new EntityJourneyBlacksmith(w);
