...
public class WorldGenDivineTree
extends WorldGenAbstractTree {
    ...
    public WorldGenDivineTree(boolean var1) {
        this(var1, rand.nextInt(4) + 4, 0, 0);
    }

    public WorldGenDivineTree(boolean var1, int var2, int var3, int var4) {
        super(var1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256) {
            ...
            boolean isSoil = block2.canSustainPlant((IBlockAccess)par1World, par3, par4 - 1, par5, ForgeDirection.UP, (IPlantable)((BlockSapling)Blocks.sapling));
                ...
                for (k1 = par4 - b0 + l; k1 <= par4 + l; ++k1) {
                    ...
                    for (int i2 = par3 - l1; i2 <= par3 + l1; ++i2) {
                        ...
                        for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
                            ...
                            this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, VanillaBlocks.divineLeaves, this.metaLeaves);
                        }
                    }
                }
                for (k1 = 0; k1 < l; ++k1) {
                    ...
                    this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, VanillaBlocks.divineWood, this.metaWood);
                }
                return true;
            }
            return false;
