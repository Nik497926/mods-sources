...
public class WorldGenApalachiaTree
extends WorldGenerator {
    ...
    public WorldGenApalachiaTree(boolean par1) {
        super(par1);
    }
    ...
    public void generateLeafNodeList() {
        ...
        while (var6 >= 0) {
            ...
            for (int var7 = 0; var7 < var1; ++var7) {
                ...
                int var15 = MathHelper.floor_double((double)(var11 * Math.sin(var13 = (double)this.rand.nextFloat() * 2.0 * Math.PI) + (double)this.basePos[0] + var9));
                int[] var17 = new int[]{var15, var3, var16 = MathHelper.floor_double((double)(var11 * Math.cos(var13) + (double)this.basePos[2] + var9))};
                ...
                int n = var19[1] = (double)var17[1] - var22 > (double)var5 ? var5 : (int)((double)var17[1] - var22);
    ...
    public void genTreeLayer(int par1, int par2, int par3, float par4, int par5, Block par6) {
        ...
        for (int var12 = -var7; var12 <= var7; ++var12) {
            ...
            while (var13 <= var7) {
                ...
                if (var14 != Blocks.air && var14 != TwilightBlocks.apalachiaLeaves) {
                    ++var13;
                    continue;
                }
                this.worldObj.setBlock(var11[0], var11[1], var11[2], par6, 0, 2);
                ++var13;
            }
        }
    }
    ...
    public void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int var4 = par2; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, 1, TwilightBlocks.apalachiaLeaves);
        }
    }

    public void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3) {
        ...
        if (var4[var6] != 0) {
            ...
            for (int var15 = 0; var15 != var16; var15 += var9) {
                ...
                this.worldObj.setBlock(var14[0], var14[1], var14[2], par3, var17, 2);
            }
        }
    }
    ...
    public void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, TwilightBlocks.apalachiaLogs);
        if (this.trunkSize == 2) {
            int[] arrn = var5;
            arrn[0] = arrn[0] + 1;
            int[] arrn2 = var6;
    ...
    public void generateLeafNodeBases() {
        ...
        for (int var1 = 0; var1 < var2; ++var1) {
            ...
            this.placeBlockLine(var3, var5, TwilightBlocks.apalachiaLogs);
        }
    }
    ...
    public int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        for (var14 = 0; var14 != var15; var14 += var8) {
            ...
            if (var16 != Blocks.air && var16 != TwilightBlocks.apalachiaLeaves) break;
        }
    ...
    public boolean validTreeLocation() {
        ...
        if (var3 != TwilightBlocks.apalachiaGrass && var3 != TwilightBlocks.apalachiaDirt) {
            return false;
        }
