...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random rand, int i, int j, int k) {
        ...
        if (!(this.regardless || w.getBlock(i, j, k) == Blocks.air && w.getBlock(i + 3, j, k) == Blocks.air && w.getBlock(i - 3, j, k) == Blocks.air && w.getBlock(i, j, k + 3) == Blocks.air && w.getBlock(i, j, k - 3) == Blocks.air && w.getBlock(i, j + height, k) == Blocks.air && w.getBlock(i += 3, j - 1, k += 3) == TwilightBlocks.wildwoodGrass)) {
            return false;
        }
