...
implements IChunkProvider {
    ...
    public void generateTerrain(int var1, int var2, Block[] var3, BiomeGenBase[] var4, double[] var5) {
        ...
        for (int x = 0; x < var6; ++x) {
            for (int y = 0; y < var6; ++y) {
                for (int z = 0; z < 32; ++z) {
                    double var13 = 0.5;
                    double var15 = this.noiseArray[(x * var9 + y) * var8 + z];
                    double var17 = this.noiseArray[(x * var9 + y + 1) * var8 + z];
                    double var19 = this.noiseArray[((x + 1) * var9 + y) * var8 + z];
                    double var21 = this.noiseArray[((x + 1) * var9 + y + 1) * var8 + z];
                    double var23 = (this.noiseArray[(x * var9 + y) * var8 + z + 1] - var15) * var13;
                    double var25 = (this.noiseArray[(x * var9 + y + 1) * var8 + z + 1] - var17) * var13;
                    double var27 = (this.noiseArray[((x + 1) * var9 + y) * var8 + z + 1] - var19) * var13;
                    double var29 = (this.noiseArray[((x + 1) * var9 + y + 1) * var8 + z + 1] - var21) * var13;
                    for (int var31 = 0; var31 < 4; ++var31) {
                        ...
                        for (int var42 = 0; var42 < 8; ++var42) {
                            int var43 = var42 + x * 8 << 11 | y * 8 << 7 | z * 4 + var31;
                            int var44 = 128;
                            double var45 = 0.25;
                            double var47 = var34;
