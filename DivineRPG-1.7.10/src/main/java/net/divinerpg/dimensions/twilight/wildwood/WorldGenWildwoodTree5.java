...
public class WorldGenWildwoodTree5
extends WorldGenerator {
    public boolean generate(World w, Random rand, int i, int j, int k) {
        int height = rand.nextInt(5) + 1;
        if (w.getBlock(i += 4, j, k += 4) != Blocks.air || w.getBlock(i + 3, j, k) != Blocks.air || w.getBlock(i - 3, j, k) != Blocks.air || w.getBlock(i, j, k + 3) != Blocks.air || w.getBlock(i, j, k - 3) != Blocks.air || w.getBlock(i, j + height, k) != Blocks.air || w.getBlock(i, j - 1, k) != TwilightBlocks.wildwoodGrass) {
            return false;
        }
        ...
        w.setBlock((i -= 4) + 0, (j += height) + 5, (k -= 4) + 4, TwilightBlocks.wildwoodLeaves);
