...
public class WorldGenLayer3SmallTree
extends WorldGenerator {
    ...
    int heightLimit = 0;
    int height;
    double heightAttenuation = 0.818;
    double branchDensity = 0.9;
    double branchSlope = 0.681;
    double scaleWidth = 4.0;
    double leafDensity = 5.262;
    int trunkSize = 1;
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        for (var14 = 0; var14 != var15; var14 += var8) {
            ...
            if (var16 != null && var16 != Blocks.leaves) break;
        }
    ...
    boolean validTreeLocation() {
        ...
        if (var3 != Block.getBlockById((int)2) && var3 != Block.getBlockById((int)3)) {
            return false;
        }
