...
public class IceikaItems {
    ...
    public static Item frossivence = new ItemHealingSword("frossivence", ToolMaterialMod.Frossivence, 1.6f);
    ...
    public static Item icicleBow = new ItemModBow("icicleBow", 10000, 9, 18, 24000, Items.arrow, "icicleArrow");
    public static Item snowstormBow = new ItemModBow("snowstormBow", -1, 5, 13, "snowstormArrow");
    private static Object[] santaInfo = new Object[]{ChatFormats.ICEIKA, Util.GOLD + StatCollector.translateToLocal((String)"tooltip.massivebuff"), 2, ArmorInfo.SPEED, 6, ArmorInfo.MELEE_DAMAGE, ArmorInfo.HUNGER, 80, ArmorInfo.DAMAGE_REDUCTION};
