...
public class ItemModSwordDemonic
extends ItemModSword {
    ...
    public ItemModSwordDemonic(Item.ToolMaterial mat, String name, float seconds) {
        super(mat, name);
    ...
    public ItemModSwordDemonic(Item.ToolMaterial mat, String name, float seconds, float blindnessSeconds, float level, int cooldown) {
        super(mat, name);
        this.poisonSeconds = seconds;
    ...
    public ItemModSwordDemonic(Item.ToolMaterial mat, String name, float seconds, float blindnessSeconds, float level, int cooldown, String skin) {
        super(mat, name);
        this.skinName = skin;
        this.poisonSeconds = seconds;
        this.blindnessSeconds = blindnessSeconds;
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase live, EntityLivingBase player) {
        if (Ticker.timerSword == 0) {
            ...
            if (this.blindnessSeconds != 0.0f) {
                live.addPotionEffect(new PotionEffect(Potion.weakness.id, (int)(this.blindnessSeconds * 20.0f), (int)this.level + 1));
            }
    ...
    public void addInformation(ItemStack item, EntityPlayer player, List list, boolean par4) {
        ...
        list.add(ChatFormatting.GOLD + I18n.format((String)"\u041d\u0430\u043a\u043b\u0430\u0434\u044b\u0432\u0430\u0435\u0442 \u043d\u0430 \u0446\u0435\u043b\u044c \u0438\u0441\u0441\u0443\u0448\u0435\u043d\u0438\u0435 \u043d\u0430 3 \u0441\u0435\u043a\u0443\u043d\u0434(-\u044b)", (Object[])new Object[0]));
