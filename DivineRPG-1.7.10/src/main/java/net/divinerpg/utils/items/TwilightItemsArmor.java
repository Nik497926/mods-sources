...
public class TwilightItemsArmor {
    ...
    private static Object[] halInfo = new Object[]{8, ArmorInfo.MELEE_DAMAGE};
    ...
    private static Object[] awakenedInfo = new Object[]{10, ArmorInfo.MELEE_DAMAGE};
    public static Item awakenedHelmet = new ItemDivineArmor(EnumArmor.AWAKEN, HEAD, awakenedInfo);
    public static Item awakenedChestplate = new ItemDivineArmor(EnumArmor.AWAKEN, BODY, awakenedInfo);
    public static Item awakenedLeggings = new ItemDivineArmor(EnumArmor.AWAKEN, LEGS, awakenedInfo);
    public static Item awakenedBoots = new ItemDivineArmor(EnumArmor.AWAKEN, BOOTS, awakenedInfo);
    private static Object[] arcaniumInfo = new Object[]{7, ArmorInfo.MELEE_DAMAGE, ArmorInfo.MANA_IMMUNE};
    public static Item arcaniumHelmet = new ItemDivineArmor(EnumArmor.ARCANA, HEAD, arcaniumInfo);
    public static Item arcaniumChestplate = new ItemDivineArmor(EnumArmor.ARCANA, BODY, arcaniumInfo);
    public static Item arcaniumLeggings = new ItemDivineArmor(EnumArmor.ARCANA, LEGS, arcaniumInfo);
    public static Item arcaniumBoots = new ItemDivineArmor(EnumArmor.ARCANA, BOOTS, arcaniumInfo);
    private static Object[] darkInfo = new Object[]{ArmorInfo.DARK_EFF};
    public static Item darkHelmet = new ItemDivineArmor(EnumArmor.DARK, HEAD, darkInfo);
    public static Item darkChestplate = new ItemDivineArmor(EnumArmor.DARK, BODY, darkInfo);
    public static Item darkLeggings = new ItemDivineArmor(EnumArmor.DARK, LEGS, darkInfo);
    public static Item darkBoots = new ItemDivineArmor(EnumArmor.DARK, BOOTS, darkInfo);
    private static Object[] lightInfo = new Object[]{ArmorInfo.LIGHT_EFF};
    public static Item lightHelmet = new ItemDivineArmor(EnumArmor.LIGHT, HEAD, lightInfo);
    public static Item lightChestplate = new ItemDivineArmor(EnumArmor.LIGHT, BODY, lightInfo);
    public static Item lightLeggings = new ItemDivineArmor(EnumArmor.LIGHT, LEGS, lightInfo);
    public static Item lightBoots = new ItemDivineArmor(EnumArmor.LIGHT, BOOTS, lightInfo);
