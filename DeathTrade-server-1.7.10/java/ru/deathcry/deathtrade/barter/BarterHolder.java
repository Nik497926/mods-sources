...
public class BarterHolder {
    ...
    private boolean trade() {
        ...
        if (this.exchanger.getMoneyPlaced() > 0.0 && MySQL.getPlayerBalance(this.exchanger.getName()) < this.exchanger.getMoneyPlaced()) {
        ...
        if (this.exchanger2.getMoneyPlaced() > 0.0 && MySQL.getPlayerBalance(this.exchanger2.getName()) < this.exchanger2.getMoneyPlaced()) {
        ...
        if (this.exchanger.getMoneyPlaced() > 0.0) {
            MySQL.transferBalance(this.exchanger.getName(), this.exchanger2.getName(), this.exchanger.getMoneyPlaced());
        }
        if (this.exchanger2.getMoneyPlaced() > 0.0) {
            MySQL.transferBalance(this.exchanger2.getName(), this.exchanger.getName(), this.exchanger2.getMoneyPlaced());
        }
