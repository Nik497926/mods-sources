...
public class ContainerFocusPouch extends Container
{
	...
	public ContainerFocusPouch(InventoryPlayer inventoryPlayer, World world, int x, int y, int z)
	{
		this.worldObj = world;
		this.posX = x;
		this.posY = y;
	...
	protected void bindPlayerInventory(InventoryPlayer inventoryPlayer)
	{
		...
		for (int i = 0; i < 9; ++i)
		{
			Slot slot = this.addSlotToContainer(new Slot(inventoryPlayer, i, 8 + i * 18, 209));

			// TODO gamerforEA code start
			if (slot.getSlotIndex() == this.blockedSlotIndex)
				this.blockedSlotNumber = slot.slotNumber;
			// TODO gamerforEA code end
		}
	}
	...
	public boolean canInteractWith(EntityPlayer player)
	{
		...
		return this.blockedSlotIndex == player.inventory.currentItem && isSameItemInventory(this.pouch, player.getCurrentEquippedItem());
		// TODO gamerforEA code end
	}
