...
public class ItemGolemBell extends Item
{
	...
	public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer player, EntityLivingBase target)
	{
		if (target instanceof EntityGolemBase)
		{
			...
			if (player != null && !player.getGameProfile().equals(((EntityGolemBase) target).fake.getProfile()) && !EventUtils.hasPermission(player, EventConfig.golemRemovePermission))
				return false;
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
	{
		...
		if (entity instanceof EntityGolemBase && !entity.isDead)
		{
			...
			// TODO gamerforEA code start
			if (!player.getGameProfile().equals(((EntityGolemBase) entity).fake.getProfile()) && !EventUtils.hasPermission(player, EventConfig.golemRemovePermission))
				return false;
			// TODO gamerforEA code end
