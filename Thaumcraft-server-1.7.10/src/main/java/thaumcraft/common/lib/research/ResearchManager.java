...
public class ResearchManager
{
		...
		try
		{
			if (out == null && Thaumcraft.proxy.getClientWorld() == null && MinecraftServer.getServer() != null)
			{
				...
				if (entityplayermp != null)
				{
					...
					File file = new File(dir, id + ".thaum");
					File backupFile = new File(dir, id + ".thaumbak");
					loadPlayerData(entityplayermp, file, backupFile, false);
				}
	...
	public static boolean doesPlayerHaveRequisites(String playername, String key)
	{
		...
		String[] parents = research.parents;
		...
		parents = research.parentsHidden;
		// TODO gamerforEA code end
	...
	public static void loadPlayerData(EntityPlayer player, File file, File backupFile, boolean legacy)
	{
		try
		{
	...
	public static boolean savePlayerData(EntityPlayer player, File file, File backupFile)
	{
