...
public class CustomTextField extends Gui {
	...
	public CustomTextField(int x, int y, int width, int height) {
		this.field_146211_a = Minecraft.getMinecraft().fontRenderer;
		this.xPosition = x;
		this.yPosition = y;
		this.width = width;
		this.height = height;
	...
	public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
		...
		if (this.isFocused && p_146192_3_ == 0) {
			...
			String s = this.field_146211_a.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				Util.drawGradientRect(this.xPosition - 0.3F, this.yPosition - 0.3F, this.xPosition + this.width + 0.3F,
						this.yPosition + this.height + 0.3F, Util.color(40, 44, 51, 255), Util.color(40, 44, 51, 255));
				Util.drawGradientRect(this.xPosition, this.yPosition, this.xPosition + width,
						this.yPosition + this.height, Util.color(20, 23, 30, 255), Util.color(20, 23, 30, 255));
			}
			if (getText().length() < 1 && !isFocused())
				CustomFontRenderer.drawString("§8Название предмета", xPosition + 4, yPosition + height / 2 - 4,
						CustomFont.gui);
			...
			if (s.length() > 0) {
				...
				j1 = this.field_146211_a.drawStringWithShadow("§7" + s1, l, i1, i);
			}
			...
			if (s.length() > 0 && flag && j < s.length()) {
				this.field_146211_a.drawStringWithShadow("§7" + s.substring(j), j1, i1, i);
			}
			...
			if (flag1) {
				if (flag2) {
					...
					this.field_146211_a.drawStringWithShadow("§7" + "_", k1, i1, i);
				}
			}
