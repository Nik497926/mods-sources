...
import tueajtwut.twautjwta.asm.HookInjectorFactory.MethodEnter;
import tueajtwut.twautjwta.asm.HookInjectorFactory.MethodExit;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
	...
	public class Builder extends AsmHook {
		 ...
		 * ещё и описание.
		 * <p/>
		 * Примеры использования: import static tueajtwut.twautjwta.asm.TypeHelper.*
