...
import tueajtwut.twautjwta.asm.AsmHook;
import tueajtwut.twautjwta.asm.ClassMetadataReader;
import tueajtwut.twautjwta.asm.HookClassTransformer;

import java.util.Map;

/**
 * Удобная базовая реализация IFMLLoadingPlugin для использования twautjwta.
