...
//				int k = iter.key();
//				int v = iter.value();
//				futures.add(threadPool.submit(() -> tickChunk(k, v, random)));
//			}
//
...
//		}
	 ...
	 * @author FatonnDev
	 */
	protected void tickChunk(int chunkCoord, int priority, Random random) {
		...
		if (this.isRaining() && this.isThundering() && provider.canDoLightning(chunk) && random.nextInt(100000) == 0) {
