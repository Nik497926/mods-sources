...
public class VetheaBlocks {
    ...
    public static Block metalCaging = new BlockModGlass("metalCaging", 1.0f).setStepSound(Block.soundTypeMetal).setCreativeTab((CreativeTabs)DivineRPGTabs.vethea);
    ...
    public static Block villageLamp = new BlockMod(EnumBlockType.GLASS, "villageLamp", 1.0f, DivineRPGTabs.vethea).setLightLevel(1.0f);
    public static Block cellLamp = new BlockMod(EnumBlockType.GLASS, "cellLamp", 1.0f, DivineRPGTabs.vethea).setLightLevel(1.0f);
    public static Block barredDoor = new BlockModDoor(EnumBlockType.IRON, "barredDoorBlock", 0.5f, true);
    public static Block firelight = new BlockMod(EnumBlockType.GLASS, "firelight", 1.0f, DivineRPGTabs.vethea).setLightLevel(1.0f).setResistance(1.0f);
    ...
    public static BlockHelioticBeam helioticBeam = new BlockHelioticBeam("helioticBeam");
