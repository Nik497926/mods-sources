...
public class TwilightBlocks {
    ...
    public static Block edenBlock = new BlockMod("edenBlock", 9.0f);
    public static Block wildwoodBlock = new BlockMod("wildwoodBlock", 9.0f);
    public static Block apalachiaBlock = new BlockMod("apalachiaBlock", 9.0f);
    public static Block skythernBlock = new BlockMod("skythernBlock", 9.0f);
    public static Block mortumBlock = new BlockMod("mortumBlock", 9.0f);
