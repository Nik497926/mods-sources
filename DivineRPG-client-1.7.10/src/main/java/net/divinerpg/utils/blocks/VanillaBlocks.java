...
public class VanillaBlocks {
    ...
    public static Block rupeeBlock = new VanillaBlock(EnumBlockType.ROCK, "rupeeBlock", 5.0f, DIAMOND).setResistance(10.0f);
    public static Block arlemiteBlock = new VanillaBlock(EnumBlockType.ROCK, "arlemiteBlock", 5.0f, DIAMOND).setResistance(10.0f);
    public static Block realmiteBlock = new VanillaBlock(EnumBlockType.ROCK, "realmiteBlock", 5.0f, IRON).setResistance(10.0f);
    public static Block bloodgemBlock = new VanillaBlock(EnumBlockType.ROCK, "bloodgemBlock", 5.0f, DIAMOND).setResistance(10.0f);
    public static Block netheriteBlock = new VanillaBlock(EnumBlockType.ROCK, "netheriteBlock", 5.0f, DIAMOND).setResistance(10.0f);
    ...
    public static Block blueStone = new VanillaBlock(EnumBlockType.ROCK, "blueStone", 1.5f, WOOD_GOLD).setResistance(10.0f).setLightLevel(1.0f);
    public static Block blueVane = new VanillaBlock(EnumBlockType.ROCK, "blueVane", 2.0f, IRON).setResistance(10.0f);
    public static Block cyanVane = new VanillaBlock(EnumBlockType.ROCK, "cyanVane", 2.0f, IRON).setResistance(10.0f);
    public static Block purpleVane = new VanillaBlock(EnumBlockType.ROCK, "purpleVane", 2.0f, IRON).setResistance(10.0f);
    public static Block redVane = new VanillaBlock(EnumBlockType.ROCK, "redVane", 2.0f, IRON).setResistance(10.0f);
    public static Block yellowVane = new VanillaBlock(EnumBlockType.ROCK, "yellowVane", 2.0f, IRON).setResistance(10.0f);
    public static Block divineRock = new VanillaBlock(EnumBlockType.ROCK, "divineRock", 1.5f, STONE).setResistance(10.0f);
    ...
    public static Block darkStone = new VanillaBlock(EnumBlockType.ROCK, "darkstone", 50.0f, DIAMOND).setResistance(2000.0f).setLightLevel(1.0f);
