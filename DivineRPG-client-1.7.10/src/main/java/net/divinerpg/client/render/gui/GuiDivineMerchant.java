...
extends GuiContainer {
    ...
    public void updateScreen() {
        super.updateScreen();
        MerchantRecipeList var1 = this.theIMerchant.getRecipes((EntityPlayer)this.mc.thePlayer);
        if (var1 != null) {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
        ...
        MerchantRecipeList merchantrecipelist = this.theIMerchant.getRecipes((EntityPlayer)this.mc.thePlayer);
