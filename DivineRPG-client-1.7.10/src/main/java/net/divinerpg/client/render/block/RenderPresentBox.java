...
public class RenderPresentBox
extends TileEntitySpecialRenderer {
    private static final ResourceLocation texture = new ResourceLocation("divinerpg:textures/model/presentBox.png");
    private ModelPresentBox model = new ModelPresentBox();

    public void render(TileEntityPresentBox entity, double x, double y, double z, float f) {
        this.model = new ModelPresentBox();
        ...
        f1 = 1.0f - f1;
        f1 = 1.0f - f1 * f1 * f1;
        this.model.lid.rotateAngleX = -(f1 * (float)Math.PI / 2.0f);
