    ...
    public void onEntityCollidedWithBlock(World world, int xPos, int yPos, int zPos, Entity entity) {
        if (entity.ridingEntity == null && entity.riddenByEntity == null) {
            if (entity instanceof EntityPlayerMP) {
                ...
                } else if (thePlayer.dimension != this.dimensionID) {
                    thePlayer.timeUntilPortal = 10;
                ...
                entity.timeUntilPortal = entity.dimension != this.dimensionID ? 10 : 10;
            }
        }
    }
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
        ...
        if (world.getBlock(x, i1 - 1, z) != this.blockFrame) {
            ...
            if (j1 == 3 && world.getBlock(x, i1 + j1, z) == this.blockFrame) {
                ...
                boolean bl = flag1 = world.getBlock(x, y, z - 1) == this || world.getBlock(x, y, z + 1) == this;
                if (flag && flag1) {
                    world.setBlockToAir(x, y, z);
    ...
    public boolean tryCreatePortal(World world, int x, int y, int z) {
        ...
        for (i = -1; i <= 2; ++i) {
            for (j = -1; j <= 3; ++j) {
                ...
                if (!(flag ? b1 != this.blockFrame : !isAir && b1 != this.fireBlock)) continue;
                return false;
            }
        }
