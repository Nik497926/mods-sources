...
extends EntityDivineRPGVillager {
    ...
    public void addRecipies(MerchantRecipeList list) {
        ...
        list.add((Object)new InfiniteTrade(new ItemStack(IceikaItems.snowflake, 4), new ItemStack(VanillaItemsWeapons.serenadeStriker, 1, 0), new ItemStack(IceikaItems.serenadeOfIce, 1, 0)));
        ...
        list.add((Object)new InfiniteTrade(new ItemStack(IceikaItems.snowflake, 6), new ItemStack(VanillaItemsWeapons.massivence, 1, 0), new ItemStack(IceikaItems.frossivence, 1, 0)));
