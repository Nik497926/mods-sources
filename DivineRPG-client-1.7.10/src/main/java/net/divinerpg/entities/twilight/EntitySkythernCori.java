...
public class EntitySkythernCori
extends EntityDivineRPGFlying {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EntityStats.skythernCoriHealth);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(EntityStats.skythernCoriSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(EntityStats.skythernCoriFollowRange);
    }
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity((Entity)this) < d4 * d4) {
            ...
            if (this.canEntityBeSeen(this.targetedEntity)) {
                ...
                if (this.attackCounter == 20) {
                    ...
                    EntityCoriShot shot = new EntityCoriShot(this.worldObj, (EntityLivingBase)this, 100.0f);
