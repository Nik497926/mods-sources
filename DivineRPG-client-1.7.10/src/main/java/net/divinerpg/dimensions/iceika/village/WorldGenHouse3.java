...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random var2, int x, int y, int z) {
        ...
        ItemDoor.placeDoorBlock((World)w, (int)(x + 5), (int)(y + 1), (int)z, (int)1, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 4), (int)(y + 1), (int)z, (int)1, (Block)IceikaBlocks.steelDoorBlock);
