...
public class WorldGenWildwoodTree1
extends WorldGenAbstractTree {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256) {
            ...
            boolean bl = isSoil = block2 == TwilightBlocks.wildwoodGrass;
            if (isSoil && par4 < 256 - l - 1) {
                ...
                for (k1 = 0; k1 < l; ++k1) {
                    ...
                    if (par2Random.nextInt(3) <= 0 || !par1World.isAirBlock(par3, par4 + k1, par5 + 1)) continue;
