...
extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, int i, int j, int k) {
        ...
        world.setBlock(i + 1, j + 0, k + 2, VetheaBlocks.firelight);
        ...
        world.setBlock(i + 2, j + 0, k + 1, VetheaBlocks.firelight);
        world.setBlock(i + 2, j + 0, k + 2, VetheaBlocks.firelight);
        world.setBlock(i + 2, j + 1, k + 0, VetheaBlocks.darkEverstone);
        world.setBlock(i + 2, j + 1, k + 1, VetheaBlocks.darkEverstone);
