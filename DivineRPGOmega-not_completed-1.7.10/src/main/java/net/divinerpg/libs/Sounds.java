...
public class Sounds {
    ...
    public static Sound magmaGiant = new Sound("magmaGiant");
    public static Sound spyclopsHurt = new Sound("spyclopsHurt");
    public static Sound rock = new Sound("rock");
    public static Sound rockiteGolem = new Sound("rockiteGolem");
    public static Sound caveMob = new Sound("caveMob");
    public static Sound dynaster = new Sound("dynaster");
    public static Sound dynasterHurt = new Sound("dynasterHurt");
    public static Sound dynasterDeath = new Sound("dynasterDeath");
    public static Sound hongo = new Sound("hongo");
    public static Sound sandCrawlerHurt = new Sound("sandCrawlerHurt");
    public static Sound insecto = new Sound("insecto");
    public static Sound insectoHurt = new Sound("insectoHurt");
    public static Sound robot = new Sound("robot");
    public static Sound robotHurt = new Sound("robotHurt");
    public static Sound robotDeath = new Sound("robotDeath");
    public static Sound reaper = new Sound("reaper");
    public static Sound reaperHurt = new Sound("reaperHurt");
    public static Sound bird = new Sound("bird");
    public static Sound birdHurt = new Sound("birdHurt");
    public static Sound birdDeath = new Sound("birdDeath");
    public static Sound shimmerer = new Sound("shimmerer");
    public static Sound shimmererHurt = new Sound("shimmererHurt");
    public static Sound shimmererDeath = new Sound("shimmererDeath");
    public static Sound bossDeath = new Sound("bossDeath");
    public static Sound netherBeast = new Sound("netherBeast");
    public static Sound netherBeastHurt = new Sound("netherBeastHurt");
    ...
    public static Sound hammer = new Sound(true, "hammer");
    public static Sound plasma = new Sound(true, "plasma");
