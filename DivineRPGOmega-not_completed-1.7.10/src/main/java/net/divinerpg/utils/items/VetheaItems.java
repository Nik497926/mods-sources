...
import net.divinerpg.items.vethea.*;
...
public class VetheaItems {
    ...
    public static Item dreamSweets = new ItemVetheanHealingFood(0, 0.0f, false, 2, "dreamSweets");
    public static Item dreamSours = new ItemVetheanHealingFood(0, 0.0f, false, 8, "dreamSours");
    ...
    public static Item teakerHammer = new ItemVetheanSword("teakerHammer", Util.addHammerMaterial(6.0f));
    public static Item amthrimisHammer = new ItemVetheanSword("amthirmisHammer", Util.addHammerMaterial(8.0f));
    public static Item darvenHammer = new ItemVetheanSword("darvenHammer", Util.addHammerMaterial(12.0f));
    public static Item cermileHammer = new ItemVetheanSword("cermileHammer", Util.addHammerMaterial(15.0f));
    public static Item pardimalHammer = new ItemVetheanSword("pardimalHammer", Util.addHammerMaterial(19.0f));
    public static Item quadroticHammer = new ItemVetheanSword("quadroticWarhammer", Util.addHammerMaterial(24.0f));
    public static Item karosHammer = new ItemVetheanSword("karosWarhammer", Util.addHammerMaterial(26.0f));
    public static Item heliosisHammer = new ItemVetheanSword("heliosisWrathhammer", Util.addHammerMaterial(33.0f));
    public static Item arksianeHammer = new ItemVetheanSword("arksianeWrathhammer", Util.addHammerMaterial(38.0f));
    public static Item teakerSword = new ItemVetheanSword("teakerBacksword", Util.addHammerMaterial(4.0f));
    public static Item amthrimisSword = new ItemVetheanSword("amthirmisBacksword", Util.addHammerMaterial(6.0f));
    public static Item darvenSword = new ItemVetheanSword("darvenBacksword", Util.addHammerMaterial(9.0f));
    public static Item cermileSword = new ItemVetheanSword("cermileBacksword", Util.addHammerMaterial(13.0f));
    public static Item pardimalSword = new ItemVetheanSword("pardimalBacksword", Util.addHammerMaterial(16.0f));
    public static Item quadroticSword = new ItemVetheanSword("quadroticWarsword", Util.addHammerMaterial(20.0f));
    public static Item karosSword = new ItemVetheanSword("karosWarsword", Util.addHammerMaterial(22.0f));
    public static Item heliosisSword = new ItemVetheanSword("heliosisWrathsword", Util.addHammerMaterial(29.0f));
    public static Item arksianeSword = new ItemVetheanSword("arksianeWrathsword", Util.addHammerMaterial(36.0f));
    ...
    public static Item everlight = new ItemModSword(ToolMaterialMod.everlight, "everlight");
    public static Item everbright = new ItemVetheanClaw(46, "everbright");
    ...
    public static Item evernight = new ItemStaff(110, 120, "evernight");
    public static Item karosRockmaul = new ItemModSword(ToolMaterialMod.karos, "karosRockmaul");
    ...
    private static Object[] basicHelmInfo = new Object[]{15, ArmorInfo.MELEE_PROTECTION};
    private static Object[] basicMaskInfo = new Object[]{15, ArmorInfo.RANGED_PROTECTION};
    private static Object[] basicHoodInfo = new Object[]{15, ArmorInfo.ARCANA_PROTECTION};
    private static Object[] glisteningHelmInfo = new Object[]{15, ArmorInfo.MELEE_PROTECTION, 3, ArmorInfo.MELEE_DAMAGE};
    private static Object[] glisteningMaskInfo = new Object[]{15, ArmorInfo.RANGED_PROTECTION, 1.4, ArmorInfo.SPEED};
    private static Object[] glisteningHoodInfo = new Object[]{15, ArmorInfo.ARCANA_PROTECTION, 2, ArmorInfo.JUMP_HEIGHT, ArmorInfo.NO_FALL};
    private static Object[] demonizedHelmInfo = new Object[]{15, ArmorInfo.MELEE_PROTECTION, 6, ArmorInfo.MELEE_DAMAGE};
    private static Object[] demonizedMaskInfo = new Object[]{15, ArmorInfo.RANGED_PROTECTION, 1.8, ArmorInfo.SPEED};
    private static Object[] demonizedHoodInfo = new Object[]{15, ArmorInfo.ARCANA_PROTECTION, 3, ArmorInfo.JUMP_HEIGHT, ArmorInfo.NO_FALL};
    private static Object[] tormentedHelmInfo = new Object[]{15, ArmorInfo.MELEE_PROTECTION, 9, ArmorInfo.MELEE_DAMAGE};
    private static Object[] tormentedMaskInfo = new Object[]{15, ArmorInfo.RANGED_PROTECTION, 2.2, ArmorInfo.SPEED};
    private static Object[] tormentedHoodInfo = new Object[]{15, ArmorInfo.ARCANA_PROTECTION, 4, ArmorInfo.JUMP_HEIGHT, ArmorInfo.NO_FALL};
