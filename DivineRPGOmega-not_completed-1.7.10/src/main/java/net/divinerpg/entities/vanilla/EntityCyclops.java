...
extends EntityPeacefulUntilAttacked {
    ...
    protected void dropFewItems(boolean var1, int loot) {
        ...
        if (this.rand.nextInt(1) == 0) {
            this.dropItem(VanillaItemsOther.bloodgem, 4);
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float par2) {
        ...
        if (hurt && source.getEntity() != null && source.getEntity() instanceof EntityPlayer) {
            List entities = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(20.0, 20.0, 20.0));
