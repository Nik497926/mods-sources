...
public class modelLelyetianWarrior
extends ModelBase {
    ModelRenderer head;
    ModelRenderer body;
    ...
    public modelLelyetianWarrior() {
        ...
        this.rightarm.addBox(-1.0f, 3.0f, -17.0f, 0, 8, 14);
        ...
        this.rightarm3.addBox(-2.0f, 6.0f, -11.0f, 2, 2, 9);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.rightarm3.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + (float)Math.PI)) * 2.0f * par2 * 0.5f;
