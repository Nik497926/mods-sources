...
extends ModelBase {
    ...
    public ModelMage() {
        ...
        this.staffProng3.addBox(1.0f, -7.0f, -3.0f, 1, 2, 1);
        ...
        this.staffProng1.addBox(4.0f, -7.0f, -6.0f, 1, 2, 1);
        ...
        this.setRotation(this.ray2, 0.0f, 0.0f, 0.0f);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        this.ray3.rotateAngleZ = this.ray4.rotateAngleZ = f2 / 10.0f;
        this.ray2.rotateAngleZ = this.ray4.rotateAngleZ;
        this.ray1.rotateAngleZ = this.ray4.rotateAngleZ;
