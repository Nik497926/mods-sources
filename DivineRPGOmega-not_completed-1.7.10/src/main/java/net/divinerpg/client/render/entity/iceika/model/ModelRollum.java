...
extends ModelBase {
    ...
    public ModelRollum() {
        ...
        this.connector = new ModelRenderer((ModelBase)this, 30, 14);
        ...
        this.setRotation(this.connector, -1.570796f, 0.0f, 0.0f);
        this.rightarmtop = new ModelRenderer((ModelBase)this, 36, 16);
        ...
        this.leftarmext = new ModelRenderer((ModelBase)this, 30, 18);
        ...
        this.rightarmext = new ModelRenderer((ModelBase)this, 30, 18);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.rightarmext.rotateAngleX = MathHelper.cos((float)(-f * 0.6662f + (float)Math.PI)) * 2.0f * f1 * 0.5f;
        this.leftarmext.rotateAngleX = MathHelper.cos((float)(-f * 0.6662f)) * 2.0f * f1 * 0.5f;
