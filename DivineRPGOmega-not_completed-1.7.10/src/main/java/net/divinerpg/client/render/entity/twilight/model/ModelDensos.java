...
extends ModelBase {
    ...
    public ModelDensos() {
        ...
        this.rightarm = new ModelRenderer((ModelBase)this, 40, 4);
        this.rightarm.addBox(-3.0f, -2.0f, -2.0f, 4, 18, 4);
        this.rightarm.setRotationPoint(-5.0f, 2.0f, 0.0f);
        this.rightarm.setTextureSize(64, 32);
        this.rightarm.mirror = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        this.leftarm = new ModelRenderer((ModelBase)this, 40, 1);
    ...
    public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6) {
        ...
        this.head4.rotateAngleY = var4 / 57.295776f;
        this.head4.rotateAngleX = var5 / 57.295776f;
