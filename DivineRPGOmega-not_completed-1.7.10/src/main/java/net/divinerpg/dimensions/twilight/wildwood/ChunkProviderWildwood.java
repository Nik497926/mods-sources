...
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodTree1;
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodTree2;
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodTree3;
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodTree4;
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodTree5;
import net.divinerpg.dimensions.twilight.wildwood.WorldGenWildwoodWater;
...
public class ChunkProviderWildwood
implements IChunkProvider {
    ...
    public Chunk provideChunk(int i, int j) {
        ...
        for (int n = 0; n < Short.MAX_VALUE; ++n) {
            if (blocks[n] != TwilightBlocks.wildwoodGrass || blocks[n + 1] == null) continue;
            blocks[n] = TwilightBlocks.wildwoodDirt;
        }
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j) {
        ...
        double var11 = 0.25;
        for (int var132 = 0; var132 < 20; ++var132) {
        ...
        if (this.rand.nextInt(2) == 0) {
            tree5.generate(this.worldObj, this.rand, x, y, z);
        }
    ...
    private double[] initializeNoiseField(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        this.noise3 = this.noiseGen3.generateNoiseOctaves(this.noise3, var2, var3, var4, var5, var6, var7, var8 / 480.0, var8 / 800.0, (var8 *= 2.0) / 480.0);
