...
extends WorldGenerator {
    ...
    public boolean generate(World w, Random r, int x, int y, int z) {
        if (!(this.locationIsValidSpawn(w, x, y, z) && this.locationIsValidSpawn(w, x + 3, y, z) && this.locationIsValidSpawn(w, x + 3, y, z + 3) && this.locationIsValidSpawn(w, x, y, z + 3))) {
            return false;
        }
        ...
        ItemDoor.placeDoorBlock((World)w, (int)(x + 6), (int)(y + 1), (int)z, (int)4, (Block)IceikaBlocks.steelDoorBlock);
        ItemDoor.placeDoorBlock((World)w, (int)(x + 7), (int)(y + 1), (int)z, (int)1, (Block)IceikaBlocks.steelDoorBlock);
