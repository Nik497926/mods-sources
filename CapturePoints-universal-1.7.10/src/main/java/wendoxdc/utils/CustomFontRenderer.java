...
public class CustomFontRenderer {
		...
		return (UnicodeFont) cache.computeIfAbsent(font.font + size, (o) -> {
			...
			try {
				InputStream uf = Minecraft.getMinecraft().getResourceManager()
						.getResource(new ResourceLocation("wendoxdc", "fonts/" + font.font + ".ttf")).getInputStream();
	...
	public static void drawString(String string, int x, int y, CustomFont font) {
		drawStringWithMaxWidth(string, x, y, -1, font);
	}

	public static void drawStringWithMaxWidth(String string, int x, int y, int w, CustomFont font) {
