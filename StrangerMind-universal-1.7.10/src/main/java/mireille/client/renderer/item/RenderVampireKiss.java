...
public class RenderVampireKiss implements IItemRenderer
{
    ...
    public RenderVampireKiss(final ModelVampireKiss model, final ResourceLocation texture) {
    ...
    public static void renderSkin(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        if (type == IItemRenderer.ItemRenderType.INVENTORY) {
            GL11.glPushMatrix();
            Minecraft.getMinecraft().renderEngine.bindTexture(RenderVampireKiss.texture);
            GL11.glRotatef(-135.0f, 1.0f, 0.0f, 0.0f);
            GL11.glRotatef(45.0f, 0.0f, 1.0f, 0.0f);
            GL11.glRotatef(-45.0f, 0.0f, 0.0f, 1.0f);
            GL11.glTranslatef(-0.8f, 0.3f, -0.3f);
            RenderVampireKiss.model.render(0.0625f);
            GL11.glPopMatrix();
        }
