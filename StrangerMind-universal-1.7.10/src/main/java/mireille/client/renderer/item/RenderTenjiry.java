...
public class RenderTenjiry implements IItemRenderer
{
    ...
    public RenderTenjiry(final ModelTenjiry model, final ResourceLocation texture) {
    ...
    public static void renderSkin(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        if (type == IItemRenderer.ItemRenderType.INVENTORY) {
            GL11.glPushMatrix();
            Minecraft.getMinecraft().renderEngine.bindTexture(RenderTenjiry.texture);
            GL11.glRotatef(-135.0f, 1.0f, 0.0f, 0.0f);
            GL11.glRotatef(45.0f, 0.0f, 1.0f, 0.0f);
            GL11.glRotatef(-45.0f, 0.0f, 0.0f, 1.0f);
            GL11.glScalef(0.65f, 0.65f, 0.65f);
            GL11.glTranslatef(-0.5f, 0.5f, -0.3f);
            RenderTenjiry.model.render(0.0625f);
            GL11.glPopMatrix();
        }
