...
public class BlocksDirt extends Block
{
    private int count;
    @SideOnly(Side.CLIENT)
    private IIcon[] icon;
    
    public BlocksDirt(final String name, final String texture, final int count) {
        super(Material.grass);
        this.setBlockName(name);
        this.setBlockTextureName(texture);
        this.setCreativeTab(StrangerMind.StrangerMind);
        this.setHardness(0.1f);
        this.setStepSound(BlocksDirt.soundTypeGrass);
        this.count = count;
