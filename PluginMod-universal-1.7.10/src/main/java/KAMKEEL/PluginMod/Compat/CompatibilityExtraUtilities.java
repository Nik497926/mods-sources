...
public class CompatibilityExtraUtilities {
    ...
    private static void registerBlocks(){
        ...
        if(EUCobblestone != null){
            ...
            // Slabs
            BlockColorSlab singleSlab = new BlockColorSlab(false, Material.rock, "euCobble","cobblestone", 0);
            BlockColorSlab doubleSlab = new BlockColorSlab(true, Material.rock, "euCobble","cobblestone", 0);
            ...
            singleSlab = new BlockColorSlab(false, Material.rock, "euCobble","cobblestone", 1);
            doubleSlab = new BlockColorSlab(true, Material.rock, "euCobble","cobblestone", 1);
            doubleSlab.setDropSlab(singleSlab);

            euSingleSlab = BlockColorSlab.registerBlock(singleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);
            euDoubleSlab = BlockColorSlab.registerBlock(doubleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);

            singleSlab = new BlockColorSlab(false, Material.rock, "euCobble","cobblestone", 2);
            doubleSlab = new BlockColorSlab(true, Material.rock, "euCobble","cobblestone", 2);
            doubleSlab.setDropSlab(singleSlab);

            euSingleSlab = BlockColorSlab.registerBlock(singleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);
            euDoubleSlab = BlockColorSlab.registerBlock(doubleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);

            singleSlab = new BlockColorSlab(false, Material.rock, "euCobble","cobblestone", 3);
            doubleSlab = new BlockColorSlab(true, Material.rock, "euCobble","cobblestone", 3);
            doubleSlab.setDropSlab(singleSlab);

            euSingleSlab = BlockColorSlab.registerBlock(singleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);
            euDoubleSlab = BlockColorSlab.registerBlock(doubleSlab, ItemBlockColorSlab.class, singleSlab, doubleSlab);

            singleSlab = new BlockColorSlab(false, Material.rock, "euCobble","cobblestone", 4);
            doubleSlab = new BlockColorSlab(true, Material.rock, "euCobble","cobblestone", 4);
            doubleSlab.setDropSlab(singleSlab);
