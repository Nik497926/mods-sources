...
public class BlockAutoPool
extends BlockContainer {
    public BlockAutoPool() {
        super(Material.rock);
        this.setBlockName("blockPool");
        GameRegistry.registerBlock((Block)this, (String)"blockPool");
        GameRegistry.registerTileEntity(TileAutoPool.class, (String)"extraBotania.blockPool");
