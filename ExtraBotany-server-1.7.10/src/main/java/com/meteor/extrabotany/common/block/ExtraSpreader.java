...
IWireframeAABBProvider {
    ...
    public Block setBlockName(String par1Str) {
        GameRegistry.registerTileEntity(TileExtraSpreader.class, (String)("extrabotania." + par1Str));
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        int orientation = BlockPistonBase.determineOrientation((World)par1World, (int)par2, (int)par3, (int)par4, (EntityLivingBase)par5EntityLivingBase);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
        ...
        boolean bl = wool = heldItem != null && heldItem.getItem() == Item.getItemFromBlock((Block)Blocks.wool);
