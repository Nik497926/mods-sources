...
public class BlockDaisy
extends BlockContainer {
    public BlockDaisy() {
        super(Material.rock);
        this.setBlockName("blockDaisy");
        GameRegistry.registerBlock((Block)this, (String)"blockDaisy");
        GameRegistry.registerTileEntity(TileAutoDaisy.class, (String)"extraBotania.blockDaisy");
        this.setHardness(5.0f);
        this.setResistance(10.0f);
    }

    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileAutoDaisy();
    }
    ...
    public int getRenderType() {
        return ClientProxy.renderDaisy;
    }
}
