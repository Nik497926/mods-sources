    ...
    public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
        ...
        for (int i1 = 0; i1 < p_75904_4_; ++i1) {
            for (int j1 = 0; j1 < p_75904_3_; ++j1) {
                ...
                int l1 = (k1 & 0xF00) >> 8;
                if (AsgardGenLayerBiome.isBiomeOceanic(k1 &= 0xFFFFF0FF)) {
                ...
                if (k1 == 1) {
                    ...
                    aint1[j1 + i1 * p_75904_3_] = ((BiomeManager.BiomeEntry)WeightedRandom.getItem(this.desertBiomes, (int)(this.nextLong(WeightedRandom.getTotalWeight(this.desertBiomes) / 10) * 10L))).biome.biomeID;
                    continue;
                }
                if (k1 == 2) {
                    if (l1 > 0) {
                    ...
                    aint1[j1 + i1 * p_75904_3_] = ((BiomeManager.BiomeEntry)WeightedRandom.getItem(this.warmBiomes, (int)(this.nextLong(WeightedRandom.getTotalWeight(this.warmBiomes) / 10) * 10L))).biome.biomeID;
                    continue;
                }
                if (k1 == 3) {
                    if (l1 > 0) {
                    ...
                    aint1[j1 + i1 * p_75904_3_] = ((BiomeManager.BiomeEntry)WeightedRandom.getItem(this.coolBiomes, (int)(this.nextLong(WeightedRandom.getTotalWeight(this.coolBiomes) / 10) * 10L))).biome.biomeID;
                    continue;
                }
                aint1[j1 + i1 * p_75904_3_] = k1 == 4 ? ((BiomeManager.BiomeEntry)WeightedRandom.getItem(this.icyBiomes, (int)(this.nextLong(WeightedRandom.getTotalWeight(this.icyBiomes) / 10) * 10L))).biome.biomeID : BiomeGenBase.mushroomIsland.biomeID;
            }
        }
        return aint1;
    }
