    ...
    public void onUpdate() {
        ...
        if (this.ticksExisted >= 55) {
            ...
            if (!this.worldObj.isRemote) {
                List<EntityPlayer> var11 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox(this.posX - (double)range, this.posY - (double)range, this.posZ - (double)range, this.posX + (double)range, this.posY + (double)range, this.posZ + (double)range));
                for (EntityPlayer player : var11) {
                    if (this.summonerOdin != null) {
                        if (Math.random() <= 0.1) {
                            player.setHealth(player.getHealth() - 2.0f);
                            player.addChatComponentMessage(new ChatComponentText("\u00a7e\u0410\u0442\u0430\u043a\u0430 \u041e\u0434\u0438\u043d\u0430 \u0431\u044b\u043b\u0430 \u043c\u0435\u043d\u0442\u0430\u043b\u044c\u043d\u043e\u0439, \u0412\u0430\u0448\u0435 hp \u0443\u043f\u0430\u043b\u043e"));
                            player.setHealth(Math.max(1.0f, player.getHealth()));
                        } else {
                            player.attackEntityFrom(damageOdin, 12.0f);
                        }
                    } else {
                        player.attackEntityFrom(this.summoner == null ? DamageSource.generic : DamageSource.causeMobDamage(this.summoner), 8.0f);
                    }
