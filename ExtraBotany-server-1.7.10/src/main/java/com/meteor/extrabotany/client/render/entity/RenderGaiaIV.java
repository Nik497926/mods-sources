...
extends RenderBiped {
    ...
    public static ShaderCallback callback = new ShaderCallback(){
        ...
        public void call(int shader) {
            ...
            ARBShaderObjects.glUniform1fARB((int)disfigurationUniform, (float)RenderGaiaIII.disfiguration);
            int grainIntensityUniform = ARBShaderObjects.glGetUniformLocationARB((int)shader, (CharSequence)"grainIntensity");
            ARBShaderObjects.glUniform1fARB((int)grainIntensityUniform, (float)RenderGaiaIII.grainIntensity);
        }
    };
    public static ShaderCallback defaultCallback = new ShaderCallback(){
        ...
        public void call(int shader) {
            int disfigurationUniform = ARBShaderObjects.glGetUniformLocationARB((int)shader, (CharSequence)"disfiguration");
            ARBShaderObjects.glUniform1fARB((int)disfigurationUniform, (float)RenderGaiaIII.DEFAULT_DISFIGURATION);
            int grainIntensityUniform = ARBShaderObjects.glGetUniformLocationARB((int)shader, (CharSequence)"grainIntensity");
            ARBShaderObjects.glUniform1fARB((int)grainIntensityUniform, (float)RenderGaiaIII.DEFAULT_GRAIN_INTENSITY);
        }
    };
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        EntityGaiaIV dopple = (EntityGaiaIV)par1Entity;
