...
public class RenderTileAutoPlate
extends TileEntitySpecialRenderer {
    private static final ResourceLocation textures = new ResourceLocation(ExtraBotany.modid, "textures/blocks/models/plate.png");
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float pticks) {
        ...
        ClientProxy.modelPlate.renderAll();
        GL11.glScalef((float)1.0f, (float)-1.0f, (float)-1.0f);
        GL11.glEnable((int)32826);
        GL11.glPopMatrix();
    }
