...
public class WorldGenLayer2Forest
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256) {
            ...
            if ((b1 == VetheaBlocks.dreamGrass || b1 == VetheaBlocks.dreamDirt) && par4 < 256 - var6 - 1) {
                ...
                for (var16 = 0; var16 < var6; ++var16) {
                    Block b3;
                    Block block = b3 = world.getBlock(par3, par4 + var16, par5);
                    if (b3 != Blocks.air && block != Blocks.air && !block.isLeaves((IBlockAccess)world, par3, par4 + var16, par5)) continue;
