...
public class BlockMoonlightFurnace
extends BlockModFurnace {
    ...
    public void registerBlockIcons(IIconRegister par1IIconRegister) {
        this.side = par1IIconRegister.registerIcon("divinerpg:moonlightFurnace_side");
        this.front = par1IIconRegister.registerIcon(this.active ? "divinerpg:moonlightFurnace_front_on" : "divinerpg:moonlightFurnace_front_off");
        this.top = par1IIconRegister.registerIcon("divinerpg:moonlightFurnace_top");
    }
    ...
    public static void updateFurnaceBlockState(boolean act, World par1World, int par2, int par3, int par4) {
        ...
        keepInventory = true;
        if (act) {
            par1World.setBlock(par2, par3, par4, ArcanaBlocks.moonlightFurnaceOn);
        } else {
            par1World.setBlock(par2, par3, par4, ArcanaBlocks.moonlightFurnace);
        }
        keepInventory = false;
