...
extends EntityThrowable {
    ...
    public void onUpdate() {
        ...
        for (int var3 = 0; var3 < 8; ++var3) {
            ...
            EntityColoredFX e2 = new EntityColoredFX(this.worldObj, this.posX + (this.rand.nextDouble() - this.rand.nextDouble()) / 4.0, this.posY + (this.rand.nextDouble() - this.rand.nextDouble()) / 4.0, this.posZ + (this.rand.nextDouble() - this.rand.nextDouble()) / 4.0, 0.0, 0.0, 0.0, new Color(177, 0, 0));
            e2.bigger = true;
            e2.shortLived = true;
