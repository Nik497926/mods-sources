...
implements IDivineMetaItem {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        ...
        list.add(Util.LIGHT_PURPLE + StatCollector.translateToLocal((String)"item.spawnegg") + " " + ((String)EntityList.classToStringMapping.get(this.mobs[stack.getItemDamage()])).substring(4));
    }
